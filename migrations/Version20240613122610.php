 ...
 */
final class Version20240613122610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       /* $this->addSql('ALTER TABLE absences ADD CONSTRAINT FK_F9C0EFFFDDEAB1A3 FOREIGN KEY (etudiant_id) REFERENCES etudiant (id)');
        ...
        $this->addSql('ALTER TABLE opportunite_bourse ADD image VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
      ...
      /*  $this->addSql('ALTER TABLE absences DROP FOREIGN KEY FK_F9C0EFFFDDEAB1A3');
        ...
        $this->addSql('ALTER TABLE opportunite_bourse DROP image');
