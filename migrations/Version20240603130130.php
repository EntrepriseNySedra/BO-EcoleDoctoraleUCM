 ...
 */
final class Version20240603130130 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE domaine_recherche (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, expertise LONGTEXT NOT NULL, thematique LONGTEXT NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE projet_recherche (id INT AUTO_INCREMENT NOT NULL, domainerecherche_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, contribution VARCHAR(255) NOT NULL, methodologie VARCHAR(255) NOT NULL, objectif LONGTEXT NOT NULL, description VARCHAR(255) NOT NULL, image VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_97D9FC92BA43B783 (domainerecherche_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE projet_recherche ADD CONSTRAINT FK_97D9FC92BA43B783 FOREIGN KEY (domainerecherche_id) REFERENCES domaine_recherche (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE domaine_recherche');
