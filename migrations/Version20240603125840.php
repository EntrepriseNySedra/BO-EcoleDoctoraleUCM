 ...
 */
final class Version20240603125840 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet_recherche ADD description VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
       ...
       /* $this->addSql('ALTER TABLE absences DROP FOREIGN KEY FK_F9C0EFFFDDEAB1A3');
        ...
        $this->addSql('ALTER TABLE projet_recherche DROP description');
