 ...
 */
final class Version20240523084457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       ...
       /* $this->addSql('ALTER TABLE absences ADD CONSTRAINT FK_F9C0EFFFDDEAB1A3 FOREIGN KEY (etudiant_id) REFERENCES etudiant (id)');
        ...
        $this->addSql('ALTER TABLE programme ADD mention_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE programme ADD CONSTRAINT FK_3DDCB9FF7A4147F0 FOREIGN KEY (mention_id) REFERENCES mention (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE programme DROP mention_id');
