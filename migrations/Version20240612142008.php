 ...
 */
final class Version20240612142008 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE opportunite_bourse (id INT AUTO_INCREMENT NOT NULL, bourse_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, critere LONGTEXT DEFAULT NULL, montant DOUBLE PRECISION DEFAULT NULL, delais DATE DEFAULT NULL, UNIQUE INDEX UNIQ_B5E7E51C4E67DDD1 (bourse_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE opportunite_bourse ADD CONSTRAINT FK_B5E7E51C4E67DDD1 FOREIGN KEY (bourse_id) REFERENCES bourse_distinction (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE opportunite_bourse');
