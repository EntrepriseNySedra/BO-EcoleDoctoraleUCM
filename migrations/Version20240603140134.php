 ...
 */
final class Version20240603140134 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE projet_recherche DROP INDEX UNIQ_97D9FC92BA43B783, ADD INDEX IDX_97D9FC92BA43B783 (domainerecherche_id)');
    ...
    public function down(Schema $schema): void
    {
      ...
      /*  $this->addSql('ALTER TABLE absences DROP FOREIGN KEY FK_F9C0EFFFDDEAB1A3');
        ...
        $this->addSql('ALTER TABLE projet_recherche DROP INDEX IDX_97D9FC92BA43B783, ADD UNIQUE INDEX UNIQ_97D9FC92BA43B783 (domainerecherche_id)');
