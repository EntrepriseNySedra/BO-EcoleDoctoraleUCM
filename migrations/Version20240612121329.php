 ...
 */
final class Version20240612121329 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE admission (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, description LONGTEXT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE curriculum (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE prix (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
       /* $this->addSql('ALTER TABLE absences ADD CONSTRAINT FK_F9C0EFFFDDEAB1A3 FOREIGN KEY (etudiant_id) REFERENCES etudiant (id)');
        ...
        $this->addSql('ALTER TABLE programme DROP FOREIGN KEY FK_3DDCB9FF7A4147F0');
        $this->addSql('DROP INDEX UNIQ_3DDCB9FF7A4147F0 ON programme');
        $this->addSql('ALTER TABLE programme ADD curriculum LONGTEXT DEFAULT NULL, ADD admission LONGTEXT DEFAULT NULL, DROP mention_id');
    ...
    public function down(Schema $schema): void
    {
      ...
      /*  $this->addSql('ALTER TABLE absences DROP FOREIGN KEY FK_F9C0EFFFDDEAB1A3');
        ...
        $this->addSql('ALTER TABLE programme ADD mention_id INT DEFAULT NULL, DROP curriculum, DROP admission');
        $this->addSql('ALTER TABLE programme ADD CONSTRAINT FK_3DDCB9FF7A4147F0 FOREIGN KEY (mention_id) REFERENCES mention (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3DDCB9FF7A4147F0 ON programme (mention_id)');
