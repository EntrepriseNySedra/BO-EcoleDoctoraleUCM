 ...
 */
final class Version20240604062803 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE domaine_recherche ADD projet_recherche_id INT NOT NULL');
        $this->addSql('ALTER TABLE domaine_recherche ADD CONSTRAINT FK_A2FCB586DFD06DF8 FOREIGN KEY (projet_recherche_id) REFERENCES projet_recherche (id)');
        $this->addSql('CREATE INDEX IDX_A2FCB586DFD06DF8 ON domaine_recherche (projet_recherche_id)');
        ...
        $this->addSql('ALTER TABLE projet_recherche DROP FOREIGN KEY FK_97D9FC92BA43B783');
        $this->addSql('DROP INDEX UNIQ_97D9FC92BA43B783 ON projet_recherche');
        $this->addSql('ALTER TABLE projet_recherche DROP domainerecherche_id');
    ...
    public function down(Schema $schema): void
    {
      ...
      /*  $this->addSql('ALTER TABLE absences DROP FOREIGN KEY FK_F9C0EFFFDDEAB1A3');
        ...
        $this->addSql('ALTER TABLE domaine_recherche DROP FOREIGN KEY FK_A2FCB586DFD06DF8');
        $this->addSql('DROP INDEX IDX_A2FCB586DFD06DF8 ON domaine_recherche');
        $this->addSql('ALTER TABLE domaine_recherche DROP projet_recherche_id');
        ...
        $this->addSql('ALTER TABLE projet_recherche ADD domainerecherche_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE projet_recherche ADD CONSTRAINT FK_97D9FC92BA43B783 FOREIGN KEY (domainerecherche_id) REFERENCES domaine_recherche (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_97D9FC92BA43B783 ON projet_recherche (domainerecherche_id)');
