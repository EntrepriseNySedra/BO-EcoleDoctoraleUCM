 ...
 */
final class Version20240614061826 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE subvention_recherche (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) DEFAULT NULL, source_financement VARCHAR(255) DEFAULT NULL, exemple LONGTEXT DEFAULT NULL, critere LONGTEXT DEFAULT NULL, procedure_candidature LONGTEXT DEFAULT NULL, avantages LONGTEXT NOT NULL, image VARCHAR(255) DEFAULT NULL, projetRecherche_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_DCC006DE83DC773F (projetRecherche_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE subvention_recherche ADD CONSTRAINT FK_DCC006DE83DC773F FOREIGN KEY (projetRecherche_id) REFERENCES projet_recherche (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE subvention_recherche');
