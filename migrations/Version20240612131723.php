 ...
 */
final class Version20240612131723 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
       /* // this up() migration is auto-generated, please modify it to your needs
        ...
        $this->addSql('ALTER TABLE evenement_ecole ADD image VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
       ...
       /* $this->addSql('ALTER TABLE absences DROP FOREIGN KEY FK_F9C0EFFFDDEAB1A3');
        ...
        $this->addSql('ALTER TABLE evenement_ecole DROP image');
