 ...
 */
final class Version20240613065600 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article_ecole (id INT AUTO_INCREMENT NOT NULL, titre LONGTEXT NOT NULL, description LONGTEXT NOT NULL, detail LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, typeArticleEcole_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_7ECF18BD157C9607 (typeArticleEcole_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE type_article_ecole (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE article_ecole ADD CONSTRAINT FK_7ECF18BD157C9607 FOREIGN KEY (typeArticleEcole_id) REFERENCES type_article_ecole (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article_ecole DROP FOREIGN KEY FK_7ECF18BD157C9607');
        $this->addSql('DROP TABLE article_ecole');
        $this->addSql('DROP TABLE type_article_ecole');
